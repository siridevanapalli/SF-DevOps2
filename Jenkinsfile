	...
	echo "workspace directory is ${workspace}"
		...
		stage('Create_Delta_Package') {
			...
			{            			
				...
				rc = bat "git diff --name-only ${SF_SOURCE_COMMIT_ID} ${SF_TARGET_COMMIT_ID} | git checkout-index -f --prefix=\'C:\\ProgramData\\Jenkins\\.jenkins\\workspace\\SF-DevOps\\${SF_DELTA_FOLDER}\'"
